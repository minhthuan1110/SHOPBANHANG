...
<div class="top-nav clearfix">
    <!--tìm kiếm và thông tin người dùng bắt đầu-->
...
<!--Bắt đầu các phần thư mục bên trái trang-->
<aside>
    <div id="sidebar" class="nav-collapse">
        <!-- Bên trái menu bắt đầu-->
        ...
        <!-- Kết thúc phần menu end-->
    </div>
</aside>
<!-- hết phần biên trái trang-->
 ...
 <!-- Cuối trang -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2020. Bùi văn Thuận K18_IT01 | Design by <a href="https://www.facebook.com/profile.php?id=100035525148479">fb:Bùi thuận</a></p>
			</div>
		  </div>
  <!-- / Hết phần cuối trang -->
</section>
