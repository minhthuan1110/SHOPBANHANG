...
class HomeController extends Controller
{
    public function send_mail(){
         //send mail
                $to_name = "Bùi văn thuận";
                $to_email = "thuanxieuxao2k@gmail.com";//send to this email
    ...
    public function index(Request $request){
        ...
        $meta_keywords = "Luôn luôn đòng hành cùng quý kháck";
        $meta_title = "Sản phẩm chất lượng";
